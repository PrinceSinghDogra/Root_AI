      ...
      <div className="Hservices">
        <div className="Hservices1">
          ...
          <div className="Hservices12">
            <div className="Hservices121">
              ...
              <div className='s1line'>
               ...
               <div className='s1edge-line'></div>
                ...
                <div className="card13"><p>Ignite creativity and innovation through
                        AI-generated content, unlocking new
                        possibilities and driving transformative
                        outcomes in diverse industries.</p></div>
                         {/* <div className='s1lineContainer'>
              <div className='s1line'>
               <div className='s1edge-line'></div>
               <div className='s1middle-line'></div>
              ...
              <div className='s1line'>
               ...
               <div className='s1edge-line'></div>
                ...
                <div className="card13"><p><p>
						Custom training solutions for unique
            business  needs,   enhancing model
            accuracy and performance.					</p></p></div>
                 {/* <div className='s1lineContainer'>
              <div className='s1line'>
               <div className='s1edge-line'></div>
               <div className='s1middle-line'></div>
            ...
            role in today's data-driven world. By
             leveraging advanced techniques and 
             tools. Can gain valuable insights to 
             drive informed decision-making.										</p></div>
              ...
              <div className='s1line'>
               ...
               <div className='s1edge-line'></div>
                ...
                <div className="card13"><p><p>Expert PCB repair services across 
                                              various industries, including 
                                              defense, industrial automation, 
                                              medical, and railway sectors</p></p></div>
                 {/* <div className='s1lineContainer'>
              <div className='s1line'>
               <div className='s1edge-line'></div>
               <div className='s1middle-line'></div>
              ...
              <div className='s1line'>
               ...
               <div className='s1edge-line'></div>
                ...
                <div className="card13"><p><p><p>Seamless connectivity, real-time 
                                                 monitoring and efficient management
                                                 of your IoT devices.</p></p></p></div>
                  {/* <div className='s1lineContainer'>
              <div className='s1line'>
               <div className='s1edge-line'></div>
               <div className='s1middle-line'></div>
            ...
            */}
            ...
            <div className="learn">
              <button className="LearnB"> Learn More
              </button>
            </div>
          </div>
        </div>
      ...
      <div className='section1'>
        <div className="section11">
          <div className="section111">
            <p className='section111para1'><p>Our Latest Project</p></p>
          </div>
